...
if(name2==null)
{
	name2="Not applied";age2="Not applied";gender2=" ";
}
if(name3==null)
{
	name3="Not applied";age3="Not applied";gender3=" ";
}
...
{ int bal=rs.getInt(2);
 ...
 <table align="center" width=750  id="tab" cellpadding="5">
   <tr>
     <td rowspan="2" width=160 ><img src="new ilogo crop.jpg" width=90 height=80></td>
   <tr>
     <td colspan="4" align="center"><font color="#309" size="6"><b>Ticket</b></font><br></td>
     <td width="0"></td>
   </tr>
   <tr>
     <td width="160">PNR:</td>
     <td width="318"><%=pnr %></td>
     <td width="124">Train ID:</td>
     <td width="372"><%=t%></td>
   </tr>
   <tr>
     <td>Source:</td>
   ...
   <br>
   <tr>
     <td colspan="2"><font size=5 color="#309"><b><u>Passenger Details: </u></b></font></td>
   </tr>
   <tr>
     <td><%=name1 %></td>
     <td><%=age1 %></td>
...
<%}else{
	out.println("Card information wrong.Please give correct information.");%>
