...
<tr>
	 ...
	 <% String s=request.getParameter("sels");
        ...
        PreparedStatement ps=con.prepareStatement("select t.train_id,t.train_name,s.station_name,d.station_name,t.d_time,t.a_time,t.travel,t.ac_first,t.ac_second,t.ac_third,t.sleeper from t_info t,station s,station d where t.source_code=? and t.destination_code=? and s.station_code=t.source_code and d.station_code=t.destination_code ");
        ps.setString(1,s);
        ps.setString(2,d);
      ...
      %>
      <table border="1">
      <tr><td><b><font color="#000000">Train ID</font></b></td>
      <td><b><font color="#000000">Train Name</font></b></td>
      <td><b><font color="#000000">Source</font></b></td>
      <td><b><font color="#000000">Destionation</font></b></td>
      <td><b><font color="#000000">AC_First</font></b></td>
      <td><b><font color="#000000">AC_Second</font></b></td>
      <td><b><font color="#000000">AC_Third</font></b></td>
      <td><b><font color="#000000">Sleeper</font></b></td></tr>
