...
<tr>
     <td width=350 valign="top">
        ...
        <table width=300 height=300 id="bor">
              <tr>
                 <td height=35 id="menu" align="center" colspan=2><font color="#FFFFCC" size=6 ><b>LOGIN</b></font>
                 </td>
               </tr>
              <tr>
                 <td align="center"><font size=4 color="#309"><b>Username</b></font></td>
                 <td><input type="text" placeholder="username" name="inuser" required ></td>
              </tr>
              <tr>
                  <td valign="top" align="center"><font size=4 color="#309"><b>Password</b></font></td><td valign="top">                    <input type="password" name="inpass" placeholder="password"                    required><br>
              <%String r=(String)session.getAttribute("remark"); if(r!=null)out.println("<font color=red>"+r+"</font>");%></td>
              </tr>
              <tr>
                 <td colspan=2 height=100 align="center" valign="top" ><input type="submit" value="LOGIN"><br>                    <br><a href="signup.jsp">New User? Sign Up</a                   ><br></td>
               </tr>
        ...
        <td valign="top" width="150" align="right"><br><br><font size=4 color="#309"><b><u>Source Station</u></b></font>
         </td>
         <td valign="top"><br><br>&nbsp;&nbsp;&nbsp;&nbsp;
         <select name="sels">
     ...
     <input type="submit" value="Get Details">
          ...
          <td valign="top" width="180" align="right"><br><br><font size=4 color="#309"><b><u>Destination Station</u></b></font></td>.
     <td valign="top"><br><br>
       <select name="seld">
          <option value="HWH">Howrah</option>
          <option value="SBC">Bangalore</option>
          <option value="NDLS">New Delhi</option>
          <option value="CST-CSTM">Mumbai</option>
          <option value="GHY">Guwahati</option>
        </select>
     </td>
