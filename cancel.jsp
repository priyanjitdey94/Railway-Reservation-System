...
<%}else
    ...
    <form action="concancel.jsp">  
     <td align="right" valign="top"><br><br><font size="4"  color="#309"><b>Enter Username</b></font><br><br><br><font size="4"  color="#309"><b>Enter PNR Number</b></font><br><br><br><input type="submit" value="Cancel Ticket"></td>
     
<td align="left" valign="top"><br><br><input type="text" name="username"><br><br><br><input type="text" name="pnr"></td>
