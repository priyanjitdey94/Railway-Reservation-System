...
<tr>
     ...
     <form action="login.jsp">
        <table width=300 height=300 id="bor">
              ...
              <tr>
              <td align="center"><font size=4 color="#309"><b>Username</b></font></td>
              <td><input type="text" placeholder="username" name="inuser" required ></td></tr>
              <tr><td valign="top" align="center"><font size=4 color="#309"><b>Password</b></font></td><td valign="top"><input type="password" name="inpass" placeholder="password" required><br>
     ...
     <td valign="top">
     <b>Schedule</b>
	 <% String s=request.getParameter("sels");
        ...
        PreparedStatement ps=con.prepareStatement("select t.train_id,t.train_name,s.station_name,d.station_name,t.d_time,t.a_time,t.travel from t_info t,station s,station d where t.source_code=? and t.destination_code=? and s.station_code=t.source_code and d.station_code=t.destination_code ");
        ps.setString(1,s);
        ps.setString(2,d);
      ...
      %>
      <table border="1">
      <tr><td><b><font color="#000000">Train ID</font></b></td><td><b><font color="#000000">Train Name</font></b></td><td><b><font color="#000000">Source</font></b></td><td><b><font color="#000000">Destionation</font></b></td><td><b><font color="#000000">Departure Time</font></b></td><td><
      <b><font color="#000000">Arrival time</font></b></td><td><b><font color="#000000">Total Time</font></b></td></tr>
    
      <%while(rs.next())
    	  {
    	  %>
       <tr><td><input type="radio" name="r1" value="<%=rs.getInt(1)%>"> <%=rs.getInt(1) %></td><td><%=rs.getString(2) %></td><td><%=rs.getString(3) %></td><td><%=rs.getString(4) %></td><td><%=rs.getString(5) %></td><td><%=rs.getString(6) %></td>
