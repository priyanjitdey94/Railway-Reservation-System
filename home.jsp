...
<tr>
     ...
     <form action="login.jsp">
        <table width=300 height=300 id="bor" >
              ...
              <td><input type="text" name="inuser" placeholder="username" required ></td></tr>
              <tr><td valign="top" align="center"><br><font size=4 color="#309"><b>Password</b></font></td><td valign="top"><br><input type="password" name="inpass" placeholder="password" required><br>
