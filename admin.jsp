...
<tr><td width="250" align="center"><c><a href="traininfo.jsp"><font color="#FFFFCC" size=5><b>Train Information</b></font></a></c></td>
...
<tr>
     ...
     <%
        ...
        if(u==null)
        {%>
     <form action="adminstatus.jsp">
        <table width=300 height=300 id="bor" >
              <tr><td height=35 id="menu" align="center" colspan=2><font color="#FFFFCC" size=6 ><b>ADMIN LOGIN</b></font></td></tr>

              <tr><td valign="top" align="center"><br><font size=4 color="#309"><b>Password</b></font></td><td valign="top"><br><input type="password" name="adminpass" placeholder="password" required><br>
                <%String r=(String)session.getAttribute("remark"); if(r!=null)out.println("<font color=red>"+r+"</font>");%></td></tr>
              <tr><td colspan=2 height=100 align="center" valign="top" ><input type="submit" value="LOGIN"></td></tr>
         ...
         <%}else
          ...
          <table width=300 height=300 id="bor">
              ...
              <font size=5 color="#000000"><b>Hello Admin</b></font><br></td>
              </tr>
     ...
     <td><img src="railway-top-img.jpg" width=650 height="288">
     </td>
</tr>     
</table>
<p>&nbsp;</p>
...
<table align="center" width=500 id="topbor">
  <tr>
    ...
    <td><a href="admin.jsp">Admin Login</a></td>
  </tr>
</table>
</body>
</html>
